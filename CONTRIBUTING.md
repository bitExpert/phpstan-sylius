...
If you wish to contribute to phpstan-sylius, please be sure to
read/subscribe to the following resources:

 -  [The PSR-2 Coding Standard](http://www.php-fig.org/psr/psr-2/)

If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/phpstan-sylius/issues/new).
...
```console
$ git clone git@github.com:bitExpert/phpstan-sylius.git
$ cd phpstan-sylius
```
...
2. Fork the repository (http://github.com/bitExpert/phpstan-sylius)
...
```console
$ git remote add {username} git@github.com:{username}/phpstan-sylius.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical phpstan-sylius repository.
...
To ssh://git@github.com/{username}/phpstan-sylius.git
